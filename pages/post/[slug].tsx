...
import { sanityClient, urlForMainImage, urlForAuthorImage } from "../../sanity";
...
function Post({ post }: Props) {
    ...
    return (
        <main>
            ...
            <article className="max-w-3xl mx-auto p-5">
                ...
                <div className="mt-10">
                    <PortableText
                        className=""
                        dataset={
                            process.env.NEXT_SANITY_PUBLIC_DATASET ||
                            "production"
                        }
                        projectId={
                            process.env.NEXT_SANITY_PUBLIC_PROJECT_ID ||
                            "projectId"
                        }
                        content={post.body}
                        serializers={{
            ...
            {/* Comments */}
            <div className="flex flex-col p-10 m-10 max-w-2xl mx-auto shadow shadow-yellow-500">
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    return {
        ...
        revalidate: 100, //after 60 seconds it would update the old cache version
    };
};
